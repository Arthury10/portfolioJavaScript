		...
		e = (function () {
			...
			return (
				...
				(e.prototype.getElementListener = function () {
					...
					if (
						'string' == typeof this.settings['mouse-event-element']
					) {
				...
				(e.prototype.updateInitialPosition = function () {
					if (
						0 !== this.settings.startX ||
						0 !== this.settings.startY
					) {
						this.onMouseEnter(),
					...
					;(this.element.style.transform =
						...
						this.glare &&
							...
							(this.glareElement.style.opacity =
								'' +
								(t.percentageY * this.settings['max-glare']) /
									100)),
					...
					clearTimeout(this.transitionTimeout),
						...
						(this.transitionTimeout = setTimeout(function () {
							;(t.element.style.transition = ''),
								t.glare &&
									(t.glareElement.style.transition = '')
						}, this.settings.speed))
				}),
